...
from pyatv_patched.core import Core, MutableService, SetupData, UpdatedState, mdns
...
from pyatv_patched.protocols.companion.api import (
    CompanionAPI,
    HidCommand,
    MediaControlCommand,
    SystemStatus,
)
from pyatv_patched.protocols.companion.pairing import CompanionPairingHandler
from pyatv_patched.support.device_info import lookup_model
