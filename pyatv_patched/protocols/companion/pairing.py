...
from pyatv_patched.protocols.companion.auth import CompanionPairSetupProcedure
from pyatv_patched.protocols.companion.connection import CompanionConnection
from pyatv_patched.protocols.companion.protocol import CompanionProtocol
