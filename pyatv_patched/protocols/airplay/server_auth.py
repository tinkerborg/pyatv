...
from pyatv_patched.auth.hap_srp import hkdf_expand
from pyatv_patched.auth.hap_tlv8 import ErrorCode, TlvValue, read_tlv, write_tlv
from pyatv_patched.auth.server_auth import PIN_CODE, PRIVATE_KEY, SERVER_IDENTIFIER
from pyatv_patched.protocols.airplay.auth.hap_transient import TRANSIENT_PIN
from pyatv_patched.support import chacha20, http, log_binary
