...
from pyatv_patched.protocols.airplay.auth.hap import (
    AirPlayHapPairSetupProcedure,
    AirPlayHapPairVerifyProcedure,
)
from pyatv_patched.protocols.airplay.auth.hap_transient import (
    AirPlayHapTransientPairVerifyProcedure,
)
from pyatv_patched.protocols.airplay.auth.legacy import (
    AirPlayLegacyPairSetupProcedure,
    AirPlayLegacyPairVerifyProcedure,
)
from pyatv_patched.protocols.airplay.srp import LegacySRPAuthHandler, new_credentials
from pyatv_patched.protocols.airplay.utils import AirPlayFlags, parse_features
from pyatv_patched.support.http import HttpConnection
