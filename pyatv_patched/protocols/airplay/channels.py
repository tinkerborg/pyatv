...
from pyatv_patched.auth.hap_channel import AbstractHAPChannel
from pyatv_patched.protocols.airplay.utils import decode_plist_body, encode_plist_body
...
from pyatv_patched.support.packet import defpacket
from pyatv_patched.support.variant import read_variant, write_variant
