...
from pyatv_patched.auth.hap_pairing import PairSetupProcedure
from pyatv_patched.const import Protocol
from pyatv_patched.core import Core
from pyatv_patched.interface import PairingHandler
from pyatv_patched.protocols.airplay.auth import AuthenticationType, pair_setup
from pyatv_patched.protocols.airplay.utils import AirPlayMajorVersion
from pyatv_patched.support import error_handler
