...
from pyatv_patched.protocols import mrp
...
from pyatv_patched.protocols.airplay.mrp_connection import AirPlayMrpConnection
from pyatv_patched.protocols.airplay.pairing import AirPlayPairingHandler
from pyatv_patched.protocols.airplay.player import AirPlayPlayer
...
from pyatv_patched.protocols.raop import setup as raop_setup
from pyatv_patched.protocols.raop.protocols import (
    StreamContext,
    StreamProtocol,
    airplayv1,
    airplayv2,
)
from pyatv_patched.support import net
from pyatv_patched.support.device_info import lookup_model, lookup_os
from pyatv_patched.support.http import HttpConnection, StaticFileWebServer, http_connect
