...
from pyatv_patched.auth.hap_pairing import NO_CREDENTIALS, HapCredentials
from pyatv_patched.protocols.raop import timing
from pyatv_patched.protocols.raop.packets import TimingPacket
from pyatv_patched.support.rtsp import FRAMES_PER_PACKET
