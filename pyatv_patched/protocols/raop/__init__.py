...
from pyatv_patched.core import (
    AbstractPushUpdater,
    Core,
    MutableService,
...
from pyatv_patched.core.scan import (
...
from pyatv_patched.protocols.airplay.auth import extract_credentials
from pyatv_patched.protocols.airplay.pairing import AirPlayPairingHandler
...
from pyatv_patched.protocols.raop.audio_source import AudioSource, open_source
from pyatv_patched.protocols.raop.protocols import StreamContext, airplayv1, airplayv2
from pyatv_patched.protocols.raop.stream_client import PlaybackInfo, RaopListener, StreamClient
from pyatv_patched.support.collections import dict_merge
from pyatv_patched.support.device_info import lookup_model, lookup_os
from pyatv_patched.support.http import HttpConnection, http_connect
from pyatv_patched.support.metadata import EMPTY_METADATA, MediaMetadata, merge_into
