...
from pyatv_patched.core import Core, mdns
from pyatv_patched.interface import PairingHandler
from pyatv_patched.protocols.dmap import tags
from pyatv_patched.support.net import get_private_addresses, unused_port
