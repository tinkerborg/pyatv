...
from pyatv_patched.auth.hap_channel import AbstractHAPChannel, setup_channel
from pyatv_patched.auth.hap_pairing import PairVerifyProcedure, parse_credentials
from pyatv_patched.auth.hap_session import HAPSession
from pyatv_patched.auth.hap_srp import SRPAuthHandler, hkdf_expand
from pyatv_patched.auth.server_auth import SERVER_IDENTIFIER
from pyatv_patched.const import Protocol
from pyatv_patched.core import MutableService, mdns
from pyatv_patched.protocols.airplay.ap2_session import (
...
from pyatv_patched.protocols.airplay.auth import extract_credentials, verify_connection
from pyatv_patched.protocols.airplay.channels import (
    BaseDataStreamChannel,
    BaseEventChannel,
    DataStreamMessage,
)
from pyatv_patched.protocols.airplay.server_auth import BaseAirPlayServerAuth
from pyatv_patched.protocols.airplay.utils import (
    decode_plist_body,
    encode_plist_body,
    log_request,
    log_response,
)
from pyatv_patched.protocols.companion.connection import (
    AUTH_TAG_LENGTH,
    CompanionConnection,
    CompanionConnectionListener,
)
from pyatv_patched.protocols.companion.protocol import (
    _AUTH_FRAMES,
    _OPACK_FRAMES,
    CompanionProtocol,
    FrameType,
...
from pyatv_patched.protocols.companion.server_auth import CompanionServerAuth
from pyatv_patched.protocols.mrp import protobuf
from pyatv_patched.protocols.mrp.connection import MrpConnection
from pyatv_patched.protocols.mrp.protocol import MrpProtocol
from pyatv_patched.protocols.mrp.server_auth import MrpServerAuth
from pyatv_patched.scripts import log_current_version
from pyatv_patched.settings import InfoSettings
from pyatv_patched.support import (
    chacha20,
    log_binary,
    log_protobuf,
    net,
...
from pyatv_patched.support.dns import format_txt_dict, parse_txt_dict
from pyatv_patched.support.http import (
    BasicHttpServer,
    HttpConnection,
    HttpRequest,
    HttpResponse,
